...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='/home/li/下载/ICAFusion-main/runs/train/baseline（kaist）/weights/best.pt', help='model.pt path(s)')
    parser.add_argument('--source1', type=str, default='/home/li/下载/ICAFusion-main/KAIST/images/test_rgb', help='source')  # file/folder, 0 for webcam
    parser.add_argument('--source2', type=str, default='/home/li/下载/ICAFusion-main/KAIST/images/test_ir', help='source')  # file/folder, 0 for webcam
    ...
    parser.add_argument('--name', default='baseline（kaist）', help='save results to project/name')
