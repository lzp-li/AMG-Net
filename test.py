...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='/home/li/下载/ICAFusion-main/runs/train/000（去除TGD和DPCF）/weights/best.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--name', default='kaist+配置60轮', help='save to project/name')
    ...
    p = "/home/li/下载/ICAFusion-main/FLIR-align-3class/labels/test_rgb"
    labels_list = os.listdir(p)
    labels_list.sort()
    if opt.data in ['./data/multispectral/FLIR-align-3class.yaml', './data/multispectral/FLIR-ADAS.yaml', './data/multispectral/kaist.yaml']:
        opt.verbose = True
